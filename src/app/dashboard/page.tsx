...
import { showSuccessToast, showErrorToast, ToastNotifications } from './ToastNotifications';
...
import { loadAllCharts, loadChartDetails, loadCourseOfferings, loadAllLecturers, loadAllClassrooms, loadAllOfferings, updateOffering, addOffering, deleteOffering } from './utils/api';
import { Chart, Term, Course, CourseDetails, CourseOffering, Lecturer, Classroom } from './utils/types';
  ...
  const handleCourseClick = async (course: Course) => {
    try {
      ...
      const offerings = await loadCourseOfferings(course.id);
        setCourseOfferings(offerings.map((o: any) => ({
        ...o,
        course: {
        id: course.id,
        name: course.name,
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center mb-2"> 
                ...
                <div className="flex space-x-2">
                  <button 
                    className="bg-green-600 hover:bg-green-700 text-white px-2 py-1.5 rounded-lg text-md transition-colors"
